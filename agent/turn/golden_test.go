...
func TestTurnDerivationGolden(t *testing.T) {
	plan := turn.PlanDigest("turn-1", es.Digest("sha256:aa"), turn.CompanionV1Version, []chatlog.InputID{"in-1", "in-2"})
	freezeTurn(t, "plan digest", string(plan), "sha256:73762c8fa91ed55d869bd3814c054eed6345a9681af4563f52165acd27423011")

	op := turn.StartOperationDigest("sess-1", "turn-1", plan)
	freezeTurn(t, "start operation digest", string(op), "sha256:af66e58e186a947419aea9f2c87568f1e6be4006408738b2923f202ded5db243")
